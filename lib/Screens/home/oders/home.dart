            ...
            onTap: () {
              Navigator.push(
                ...
                PageTransition(
                    type: PageTransitionType.rightToLeft,
                    duration: Duration(milliseconds: 400),
                    child: AddTransaction(loadCart: cartData, myList: []),
                    inheritTheme: true,
                    ctx: context),
              );
            },
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    ...
                                    localCart(cartList[index]['id'].toString());
                                  },
                                  child: Container(
                                    padding: const EdgeInsets.all(8.0),
                                    height: h / 6,
  ...
  localCart(String id) async {
    ...
    Navigator.push(
      ...
      PageTransition(
          type: PageTransitionType.rightToLeft,
          duration: Duration(milliseconds: 400),
          child: AddTransaction(loadCart: () {}, myList: addcartList),
          inheritTheme: true,
          ctx: context),
    );
    // List<dynamic> itemList = json.decode(temp);
  }
}
